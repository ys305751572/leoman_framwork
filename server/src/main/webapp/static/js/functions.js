$(document).ready(function(){
    ...
    (function(){
        ...
        $('#sidebar .menu-item').click(function(){
            $('#sidebar .menu-item').removeClass('hovered1');
            $('#sidebar .menu-item').closest('.dropdown').removeClass('hovered1');
            $(this).closest('.dropdown').addClass('hovered1');
        })

        $('#sidebar .side-menu').children("li").click(function(){
            $('#sidebar .side-menu').find("span").removeClass("bg1");
            $(this).find("span").addClass("bg1");
        })

        $('.dropdown').click(function(){
            $(this).find('ul').removeClass("menu_chioce");
            $(".menu_chioce").slideUp();
            $(this).find('ul').slideToggle();
            $(this).find('ul').addClass("menu_chioce");
        });


        $('#sidebar .side-menu').find("li").hover(function(){
            $(this).find("span").addClass("bg");
            $(this).find("li").addClass("bg");
        },function(){
