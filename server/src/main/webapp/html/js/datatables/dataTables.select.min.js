...
(function (e) {
    ...
    function u(a) {
        var b = e(a.table().body()), c = a.settings()[0], d = c._select.selector;
    ...
    function v(a) {
        ...
        if (b._select.info && b.aanFeatures.i) {
            var c = e('<span class="select-info"/>'), d = function (b, d) {
    ...
    function t(a, b, c, d, f) {
        var n = b.select.style(), g = b[d](f, {selected: !0}).any();
        ...
        }, !b.cells({selected: !0}).any() && !d ? (g = g(0, f.column), d = a(0, f.row)) : (g = g(d.column, f.column), d = a(d.row, f.row)), d = b.cells(d, g).flatten(), b.cells(f, {selected: !0}).any() ? b.cells(d).deselect() : b.cells(d).select()) : (a = c._select_lastCell ? c._select_lastCell[d] : null, g = b[d + "s"]({search: "applied"}).indexes(), a = e.inArray(a,
    ...
    h.select.init = function (a) {
        var b = a.settings()[0], c = b.oInit.select, d = h.defaults.select, c = c === i ? d : c, d = "row", f = "api", n = !1, g = !0, m = "td, th", j = "selected";
        b._select = {};
        if (!0 === c)f = "os"; else if ("string" === typeof c)f = c; else if (e.isPlainObject(c) && (c.blurable !== i && (n = c.blurable), c.info !== i && (g = c.info), c.items !== i && (d = c.items), c.style !== i && (f = c.style), c.selector !== i && (m = c.selector), c.className !== i))j = c.className;
        a.select.selector(m);
        a.select.items(d);
        a.select.style(f);
        a.select.blurable(n);
    ...
    var o = h.Api.register, p = h.Api.registerPlural;
    o("select()", function () {
            ...
            if (!b._select_init) {
                ...
                c.on("preXhr.dt.dtSelect", function () {
                    var b = c.rows({selected: !0}).ids(!0).filter(function (b) {
                        return b !==
                            i
                    }), a = c.cells({selected: !0}).eq(0).map(function (b) {
                        var a = c.row(b.row).id(!0);
                        return a ? {row: a, column: b.column} : i
                    }).filter(function (b) {
                        return b !== i
                    });
    ...
    p("columns().deselect()", "column().deselect()", function () {
        ...
        this.iterator("column", function (b, a) {
            ...
            var d = new h.Api(b), f = d.column(a);
            ...
            d.cells(null, a).indexes().each(function (a) {
                var c = b.aoData[a.row], d = c._selected_cells;
    ...
    e.extend(h.ext.buttons, {
        selected: {
            text: r("selected", "Selected"), className: "buttons-selected", init: function (a) {
                ...
                a.on("draw.dt.DT select.dt.DT deselect.dt.DT",
                    function () {
                        var a = b.rows({selected: !0}).any() || b.columns({selected: !0}).any() || b.cells({selected: !0}).any();
                        b.enable(a)
                    });
                this.disable()
            }
        ...
        selectedSingle: {
            ...
            init: function (a) {
                ...
                a.on("draw.dt.DT select.dt.DT deselect.dt.DT", function () {
                    var c = a.rows({selected: !0}).flatten().length + a.columns({selected: !0}).flatten().length + a.cells({selected: !0}).flatten().length;
                    b.enable(1 === c)
                });
                this.disable()
            }
        ...
        selectNone: {
            text: r("selectNone", "Deselect all"), className: "buttons-select-none", action: function () {
                q(this.settings()[0], !0)
            }, init: function (a) {
                var b = this;
                a.on("draw.dt.DT select.dt.DT deselect.dt.DT", function () {
