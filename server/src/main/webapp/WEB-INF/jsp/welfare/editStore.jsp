        ...
        <form id="fromId" name="formName" method="post" enctype="multipart/form-data">
            ...
            <div class="block-area">
                <div class="row">
                    ...
                    <div class="col-md-6 m-b-15">
                        <label>购买链接：</label>
                        <input type="text" id="url4" name="url4" value="${welfare.url}" class="input-sm form-control validate[required]" maxlength="20" placeholder="..."/>
                    </div>
