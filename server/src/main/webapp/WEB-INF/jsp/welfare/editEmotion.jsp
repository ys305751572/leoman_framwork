        ...
        <form id="fromId" name="formName" method="post" enctype="multipart/form-data">
            ...
            <div class="block-area">
                <div class="row">
                    ...
                    <div class="col-md-6 m-b-15">
                        <label>限制：</label>
                        <select id="limit3" name="limit3" class="select">
                    ...
                    <div class="col-md-6 m-b-15">
                        <label>馒头数：</label>
                        <input type="text" value="${welfare.coin}" class="form-control validate[required]" id="coin3" name="coin3" maxlength="20" placeholder="..."/>
                    </div>
                    <div class="col-md-12 m-b-15">
                        <label>描述：</label>
                        <textarea cols="40" rows="6" id="description3" name="description3" class="form-control" placeholder="...">${welfare.description}</textarea>
                    </div>
