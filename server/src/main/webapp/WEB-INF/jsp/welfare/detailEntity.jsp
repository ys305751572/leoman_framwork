        ...
        <form id="fromId" name="formName" method="post" enctype="multipart/form-data">
            ...
            <div class="block-area">
                <div class="row">
                    ...
                    <div class="col-md-6 m-b-15">
                        <label>馒头数：</label>
                        <input type="text" value="${welfare.coin}" class="form-control validate[required]" id="coin2" name="coin2" placeholder="..." disabled/>
                    </div>
                    <div class="col-md-6 m-b-15">
                        <label>限制：</label>
                    ...
                    <div class="col-md-12 m-b-15" style="margin-top: 10px;">
                        <label>描述：</label>
                        <textarea cols="40" rows="6" id="description2" name="description2" class="form-control" placeholder="..." disabled>${welfare.description}</textarea>
                    </div>
