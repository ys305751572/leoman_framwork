        ...
        <form id="fromId" name="formName" method="post" enctype="multipart/form-data">
            ...
            <div class="block-area">
                <div class="row">
                    ...
                    <div class="col-md-6 m-b-15">
                        <label>馒头数：</label>
                        <input type="text" value="${welfare.coin}" class="form-control validate[required]" id="coin5" name="coin5" maxlength="20" placeholder="..."/>
                    </div>
                    <div class="col-md-6 m-b-15">
                        <label>限制：</label>
                        <select id="limit5" name="limit5" class="select">
                    ...
                    <div class="col-md-12 m-b-15">
                        <label>请输入游戏码：</label>
                        <input type="text" value="${welfare.url}" class="form-control validate[required]" id="url5" name="url5" maxlength="20" placeholder="..."/>
                    </div>
