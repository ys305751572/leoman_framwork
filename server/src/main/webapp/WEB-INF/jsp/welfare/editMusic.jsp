        ...
        <form id="fromId" name="formName" method="post" enctype="multipart/form-data">
            ...
            <div class="block-area">
                <div class="row">
                    ...
                    <div class="col-md-6 m-b-15">
                        <label>馒头数：</label>
                        <input type="text" value="${welfare.coin}" class="form-control  validate[required]" id="coin" name="coin" maxlength="20" placeholder="..."/>
                    </div>
                    <div class="col-md-6 m-b-15">
                        <label>铃声时长：</label>
                        <input type="text" value="${welfare.length}" id="length" name="length" class="input-sm form-control validate[required]"placeholder="...">
                    </div>
