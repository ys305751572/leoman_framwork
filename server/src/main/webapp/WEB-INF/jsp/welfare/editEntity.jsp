        ...
        <form id="fromId" name="formName" method="post" enctype="multipart/form-data">
            ...
            <div class="block-area">
                <div class="row">
                    ...
                    <div class="col-md-6 m-b-15">
                        <label>馒头数：</label>
                        <input type="text" value="${welfare.coin}" class="form-control validate[required]" id="coin2" name="coin2" maxlength="20" placeholder="..."/>
                    </div>
                    <div class="col-md-6 m-b-15">
                        <label>限制：</label>
                        <select id="limit2" name="limit2" class="select">
                            <option value="0" <c:if test="${welfare.conditions == 0}">selected</c:if>>不限次数</option>
                            <option value="1" <c:if test="${welfare.conditions == 1}">selected</c:if>>每天仅一次</option>
                        </select>
                    </div>
                    <div class="col-md-12 m-b-15">
                        <label>描述：</label>
                        <textarea cols="40" rows="6" id="description2" name="description2" class="form-control" placeholder="...">${welfare.description}</textarea>
                    </div>
