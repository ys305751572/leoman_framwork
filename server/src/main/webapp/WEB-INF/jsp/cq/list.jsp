        ...
        <div class="block-area" id="search">
            <div class="row">
                <div class="col-md-2 form-group">
                    <label>问题</label>
                    <input type="text" class="input-sm form-control" id="question" name="question" placeholder="...">
                </div>
                <div class="col-md-2 form-group">
                    <label>答案</label>
                    <input type="text" class="input-sm form-control" id="answer" name="answer" placeholder="...">
                </div>
            </div>
        </div>
        ...
        <div class="block-area">
            <div class="row">
                <ul class="list-inline list-mass-actions">
                    <li>
                        <a data-toggle="modal" href="${contextPath}/admin/cq/add" title="新增" class="tooltips">
                            <i class="sa-list-add"></i>
                        </a>
                    </li>
                    <li>
                        <a href="${contextPath}/admin/cq/index" title="刷新" class="tooltips">
...
//                                var checkbox = "<div class=\"icheckbox_minimal\" aria-checked=\"false\" aria-disabled=\"false\" style=\"position: relative;\"><input type=\"checkbox\" value="+ data +" class='pull-left list-check' style=\"position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);\"></div>";
            ...
            edit: function (id) {
                window.location.href = "${contextPath}/admin/cq/add?id=" + id;
            },
            detail: function (id) {
                window.location.href = "${contextPath}/admin/cq/detail?id=" + id;
            },
            delete: function () {
