            ...
            <div class="block-area">
                ...
                <div class="row">
                    <div class="col-md-6 m-b-15">
                        <label>问题</label>
                        <input type="text" id="question" name="question" value="${cq.question}" class="input-sm form-control validate[required]" placeholder="..." disabled>
                    </div>
                    <hr class="whiter m-t-20"/>
                    <div class="col-md-12 m-b-15">
                        <label>答案</label>
                        <textarea id="answer" name="answer" class="form-control auto-size m-b-10" placeholder="..." disabled>${cq.answer}</textarea>
                    </div>
                    <hr class="whiter m-t-20"/>
                </div>
