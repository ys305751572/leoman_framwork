        ...
        <div class="block-area">
            <div class="row">
                <ul class="list-inline list-mass-actions">
                    ...
                    <li>
                        <a href="${contextPath}/admin/category/indexMusic" title="刷新" class="tooltips">
        ...
        <div class="modal fade" id="deletes" tabindex="-1" role="dialog" aria-labelledby="pwdModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">该分类下有音乐，无法删除？</h4>
                    </div>
                    <div class="modal-body">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
        ...
        fn: {
            ...
            dataTableInit: function () {
                category.v.dTable = $leoman.dataTable($('#dataTables'), {
                    ...
                    "searching": false,
                    "ajax": {
                        "url": "${contextPath}/admin/category/listMusic",
                        "type": "POST"
                    },
                    "columns": [
                        {
...
//                                var checkbox = "<div class=\"icheckbox_minimal\" aria-checked=\"false\" aria-disabled=\"false\" style=\"position: relative;\"><input type=\"checkbox\" value="+ data +" class='pull-left list-check' style=\"position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);\"></div>";
            ...
            "confirm": function () {
                ...
                /*$("#infoForm").ajaxSubmit({
                    url : "${contextPath}/admin/category/editMusic",
                    type : "POST",
                    data : {
