                    ...
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                <li class="new">
                                    <a href="">
                                        <span class="thumb"><img src="${contextPath}/static/html/images/photos/user1.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="${contextPath}/static/html/images/photos/user2.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="${contextPath}/static/html/images/photos/user3.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="${contextPath}/static/html/images/photos/user4.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="${contextPath}/static/html/images/photos/user5.png" alt="" /></span>
                                        <span class="desc">
                            ...
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="${contextPath}/static/html/images/photos/user1.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="${contextPath}/static/html/images/photos/user2.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="${contextPath}/static/html/images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="${contextPath}/static/html/images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="${contextPath}/static/html/images/photos/user5.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">Hoffman Doe</a> - Support
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="${contextPath}/static/html/images/photos/user2.png" alt=""/>
                                </a>
