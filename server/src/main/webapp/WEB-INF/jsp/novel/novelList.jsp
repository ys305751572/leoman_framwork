    ...
    <section id="content" class="container">
        ...
        <div class="block-area" id="search">
            <div class="row">
                ...
                <div class="col-md-2 form-group">
                    <label>已更新回数：</label>
                    <input type="text" value="${work.workVideo.series}" class="input-sm form-control" name="name" placeholder="..." disabled>
                </div>
                <div class="col-md-2 form-group">
                    <label>小说分类：</label>
        ...
        fn: {
            ...
            dataTableInit: function () {
                novel.v.dTable = $leoman.dataTable($('#dataTables'), {
                    ...
                    "searching": false,
                    "ajax": {
                        "url": "${contextPath}/admin/novel/novelList",
                        "type": "POST",
                        "data": {
                            workId: $("#id").val(),
                        },
...
//                                var checkbox = "<div class=\"icheckbox_minimal\" aria-checked=\"false\" aria-disabled=\"false\" style=\"position: relative;\"><input type=\"checkbox\" value="+ data +" class='pull-left list-check' style=\"position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);\"></div>";
                        ...
                        {"data": "work.playNum"},
                        {
                            "data": null,
                            "render": function (data) {
                                novel.v.list.push(data);
                                var detail = "<button title='编辑' class='btn btn-primary btn-circle' onclick='novel.fn.edit(" + data.id + ")'>" +
                                        "<i class='fa fa-edit'></i></button>&nbsp;&nbsp;";
                                detail += "<a title='预览' class='btn btn-primary btn-circle edit' onclick='novel.fn.list(" + data.id + ")'> " +
                                        "<i class='fa fa-eye'></i></a>&nbsp;&nbsp;";
                                detail += "<button title='删除' class='btn btn-primary btn-circle' onclick='novel.fn.delete(" + data.id + ")'> " +
            ...
            "edit": function (novelId) {
                window.location.href = "${contextPath}/admin/novel/updateEdit?novelId=" + novelId ;
            },
            "list": function (novelId) {
                window.location.href = "${contextPath}/admin/novel/detail?novelId=" + novelId ;
            },
            ...
            "delete": function (id) {
                ...
                $('#confirm').click(function () {
                    ...
                    $leoman.ajax("${contextPath}/admin/novel/delete", {
                        "novelId": id,
                    }, function (result) {
                        if (result == 1) {
