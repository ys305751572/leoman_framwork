...
<section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
        ...
        <div class="block-area">
            <a href="${contextPath}/admin/postComment/index" class="btn btn-outline btn-primary btn-lg" role="button">用户帖子</a>
            <a href="${contextPath}/admin/postComment/indexPost" class="btn btn-outline btn-primary btn-lg" role="button">官方帖子</a>
        </div>
        ...
        <div class="block-area">
            <div class="row">
                <ul class="list-inline list-mass-actions">
                    <li>
                        <a href="${contextPath}/admin/postComment/index" title="刷新" class="tooltips">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="showText">确定删除该回复？</h4>
                    </div>
        ...
        fn: {
            ...
            dataTableInit: function () {
                comment.v.dTable = $leoman.dataTable($('#dataTables'), {
                    ...
                    "searching": false,
                    "ajax": {
                        "url": "${contextPath}/admin/postComment/list",
                        "type": "POST"
                    },
                    "columns": [
                        {
...
//                                var checkbox = "<div class=\"icheckbox_minimal\" aria-checked=\"false\" aria-disabled=\"false\" style=\"position: relative;\"><input type=\"checkbox\" value="+ data +" class='pull-left list-check' style=\"position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);\"></div>";
            ...
            "delete": function (id) {
                ...
                $('#confirm').click(function () {
                    ...
                    $leoman.ajax("${contextPath}/admin/postComment/delete", {
                        "commentId": id,
                    }, function (result) {
                        if (result == 1) {
            ...
            deleteBatch: function () {
                ...
                $.ajax({
                    url : "${contextPath}/admin/postComment/deleteBatch",
                    data : {
