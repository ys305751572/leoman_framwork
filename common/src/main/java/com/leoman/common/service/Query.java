...
public class Query implements Serializable {
    ...
    /** 通过类创建查询条件 */
    public static Query forClass(Class clazz, GenericManager manager) {
        return new Query(clazz, manager.getEntityManager());
    }
    ...
    public void isNull(String propertyName) {
        ...
        this.predicates.add(criteriaBuilder.isNull(p));
    }
    ...
    public void isNotNull(String propertyName) {
        ...
        this.predicates.add(criteriaBuilder.isNotNull(p));
    }
    ...
    public void addOrder(String propertyName, String order) {
        ...
        if (order.equalsIgnoreCase("asc"))
            this.orders.add(criteriaBuilder.asc(p));
        else if (order.equalsIgnoreCase("desc"))
            this.orders.add(criteriaBuilder.desc(p));
    }
