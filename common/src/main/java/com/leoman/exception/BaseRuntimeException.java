...
public class BaseRuntimeException extends RuntimeException
{
     ...
     */
    public BaseRuntimeException(String msg, Throwable[] nested)
    {
        super(msg);
        this.nested = nested;
    }
    public BaseRuntimeException(Throwable nested)
    {
        super(nested);
     ...
     */
    public BaseRuntimeException(String msg, Object failed)
    {
        super(msg);
        this.failed = failed;
    }
     ...
     * @param failed the failed object.
     */
    public BaseRuntimeException(String msg, Throwable[] nested, Object failed)
    {
        super(msg);
        this.nested = nested;
        this.failed = failed;
     ...
     */
    public BaseRuntimeException setFatal()
    {
        fatal = true;
        return this;
    }
